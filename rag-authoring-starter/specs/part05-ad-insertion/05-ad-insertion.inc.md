<!--
  ...
  Source grounding / migration target: dashif-iop-v5-part5# published Part 5.
-->
...
Issue: Migrate and reconcile the normative requirements for Part 5 from the
...
parts. [GROUNDED_BY=dashif-iop-v5-part5# published Part 5]
